...
static float _hmc5883l_max_x, _hmc5883l_max_y, _hmc5883l_max_z; // for calibration purposes 
static float _hmc5883l_min_x, _hmc5883l_min_y, _hmc5883l_min_z;

static float _hmc5883l_x_off, _hmc5883l_y_off, _hmc5883l_z_off;
static float _hmc5883l_x_scf, _hmc5883l_y_scf, _hmc5883l_z_scf;

static bool _hmc5883l_calibrated = false;
...
bool HMC5883L::calibrate(uint8_t seconds){
    ...
    // sampling period
    h = (uint16_t)((1.0/75.0)*1000.0) - 3; // worst case scenario refresh rate of 75Hz
    Serial.println(h);
