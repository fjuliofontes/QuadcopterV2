...
class MPU6050 {
    public:
        ...
        void getMotion6(float* ax, float* ay, float* az, float* gx, float* gy, float* gz); // returns calibrated values

        void getAcceleration(int16_t* x, int16_t* y, int16_t* z);
        void getAcceleration(float* x, float* y, float* z); // returns calibrated values
        ...
        void getRotation(float* x, float* y, float* z); // returns calibrated values
    ...
    private:
        uint8_t devAddr;
        uint8_t buffer[14];
        float _mpu6050_gyro_x_cal, _mpu6050_gyro_y_cal, _mpu6050_gyro_z_cal;
        float _mpu6050_accel_x_cal, _mpu6050_accel_y_cal, _mpu6050_accel_z_cal;
